<div class="exception">
  <div class="exc-title">
    <span title="Code d'Exception">Une Exception a été levée:</span>
  </div>
  <!-- <div class="exc-title">
    ...
    <?php endforeach ?>
    <?php if ($code): ?>
      <span title="Code d'Exception">(<?php echo $tpl->escape($code) ?>)</span>
    <?php endif ?>
  </div> -->
  ...
  <div class="exc-message">
    ...
    <?php else: ?>
      <span class="exc-message-empty-notice">Pas de message</span>
    <?php endif ?>
    ...
    <ul class="search-for-help">
      ...
      <?php endif ?>
      <li>
        <a rel="noopener noreferrer" target="_blank" href="https://google.com/search?q=<?php echo urlencode(implode('\\', $name).' '.$message) ?>" title="Rechercher de l'aide sur Google.">
      ...
      <li>
        <a rel="noopener noreferrer" target="_blank" href="https://duckduckgo.com/?q=<?php echo urlencode(implode('\\', $name).' '.$message) ?>" title="Rechercher de l'aide sur DuckDuckGo.">
      ...
      <li>
        <a rel="noopener noreferrer" target="_blank" href="https://stackoverflow.com/search?q=<?php echo urlencode(implode('\\', $name).' '.$message) ?>" title="Rechercher de l'aide sur Stack Overflow.">
    ...
    <button id="copy-button" class="rightButton exc-message clipboard" style="background: #fff;color: #000;" data-clipboard-text="<?php echo $tpl->escape($plain_exception) ?>" title="Copier les détails de l'exception">
      COPIER
    </button>
    <button id="hide-error" class="rightButton" title="Cacher le message d'erreur" style="background: #0e0101b3;color: #fff;" onclick="document.getElementsByClassName('Whoops')[0].style.display = 'none';">
      CACHER
    </button>
  </div>
</div>
